...
} from '../../src/plugins/host.svelte.js';
import { createPluginWindow, type PluginWindowHandle } from '../../src/plugins/window.js';

vi.mock('../../src/plugins/window.js', () => ({ createPluginWindow: vi.fn() }));
